...
import com.tajir.R;
import com.tajir.databinding.ActivityNavMainBinding;
...
public class NavMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarNavMain.fab.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_gallery, R.id.nav_slideshow, R.id.nav_pelanggan)
